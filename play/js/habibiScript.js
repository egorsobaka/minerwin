...
let circle = null;
let gameSpcWidth = null;
let gmSpcHeight = null;
let tpblCircleWidth = null;
let tpblCircleHeight = null;
...
var circlesEngine = {
  ...
  goodCircleTap: function (typeOfCircle, numOfCircles) {
    ...
    const evilCircles = document.querySelectorAll(".evil-circle");
...
var audioPool = {
  ...
  createAudioPlayer: function (element) {
    ...
    // const mp3Link = "sounds/mp3/" + element.sound + ".mp3";
    // const oggLink = "sounds/ogg/" + element.sound + ".ogg";
